            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div>
                        ...
                        <img src="" alt="">
                        @else
                        <img src="/img/Event_default.jpg" alt="">
                        @endif
                ...
                <button class="bg-blue-500 float-right text-white rounded-md px-4 py-2 hover:bg-rose-700 transition" onclick="openModal('modelConfirm')">
